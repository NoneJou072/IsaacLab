...
class Runner:
    def __init__(self, env: Union[Wrapper, MultiAgentEnvWrapper], cfg: Mapping[str, Any]) -> None:
        ...
        self._models = self._generate_custom_models(self._env, copy.deepcopy(self._cfg))
    ...
    def _generate_custom_models(self, env: Union[Wrapper, MultiAgentEnvWrapper], cfg: Mapping[str, Any]) -> Mapping[str, Mapping[str, Model]]:
        ...
        models = {}
        print("state_spaces", state_spaces)
        for agent_id in possible_agents:
            models[agent_id] = {}
            models[agent_id]["policy"] = Policy(observation_spaces[agent_id], action_spaces[agent_id], device)
            models[agent_id]["value"] = Value(state_spaces[agent_id], action_spaces[agent_id], device)
