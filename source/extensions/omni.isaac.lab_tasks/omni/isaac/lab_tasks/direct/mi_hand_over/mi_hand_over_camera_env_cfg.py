...
class MiHandOverRGBCameraEnvCfg(DirectMARLEnvCfg):
    ...
    num_channels = 3
    observation_spaces = {
        "right_hand": 46 + num_channels * tiled_camera.height * tiled_camera.width, 
        "left_hand": 46 + num_channels * tiled_camera.height * tiled_camera.width
    }
    # num_observations_lowdim = {"right_hand": 128, "left_hand": 128}
    # num_observations_image = {
    #     "right_hand": num_channels * tiled_camera.height * tiled_camera.width, 
    #     "left_hand": num_channels * tiled_camera.height * tiled_camera.width
    # }
    state_space = 232
